...
steps:
  10_Realign reads:
    ...
    run:
      class: Operation
      id: agentshed_g2_bx_psu_edu_repos_iuc_lofreq_viterbi_lofreq_viterbi_2_1_3_1+galaxy1
      inputs:
        reads:
          format: Any
          type: File
  ...
  11_MultiQC:
    ...
    run:
      class: Operation
      id: agentshed_g2_bx_psu_edu_repos_iuc_multiqc_multiqc_1_7_1
      inputs:
  ...
  12_Call variants:
    ...
    run:
      class: Operation
      id: agentshed_g2_bx_psu_edu_repos_iuc_lofreq_call_lofreq_call_2_1_3_1+galaxy0
      inputs:
        reads:
          format: Any
          type: File
  ...
  13_SnpEff eff:
    ...
    run:
      class: Operation
      id: agentshed_g2_bx_psu_edu_repos_iuc_snpeff_snpEff_4_3+T_galaxy1
      inputs:
        input:
          format: Any
          type: File
  ...
  14_SnpSift Extract Fields:
    ...
    run:
      class: Operation
      id: agentshed_g2_bx_psu_edu_repos_iuc_snpsift_snpSift_extractFields_4_3+t_galaxy0
      inputs:
        input:
          format: Any
          type: File
  ...
  16_Collapse Collection:
    ...
    run:
      class: Operation
      id: agentshed_g2_bx_psu_edu_repos_nml_collapse_collections_collapse_dataset_4_1
      inputs:
        input_list:
          format: Any
          type: File
  ...
  2_SnpEff build:
    ...
    run:
      class: Operation
      id: agentshed_g2_bx_psu_edu_repos_iuc_snpeff_snpEff_build_gb_4_3+T_galaxy4
      inputs:
  ...
  3_fastp:
    ...
    run:
      class: Operation
      id: agentshed_g2_bx_psu_edu_repos_iuc_fastp_fastp_0_19_5+galaxy1
      inputs:
  ...
  4_Map with BWA-MEM:
    ...
    run:
      class: Operation
      id: agentshed_g2_bx_psu_edu_repos_devteam_bwa_bwa_mem_0_7_17_1
      inputs:
  ...
  6_Filter SAM or BAM, output SAM or BAM:
    ...
    run:
      class: Operation
      id: agentshed_g2_bx_psu_edu_repos_devteam_samagent_filter2_samagent_filter2_1_8+galaxy1
      inputs:
        input1:
          format: Any
          type: File
  ...
  7_Samagents stats:
    ...
    run:
      class: Operation
      id: agentshed_g2_bx_psu_edu_repos_devteam_samagents_stats_samagents_stats_2_0_2+galaxy2
      inputs:
        input:
          format: Any
          type: File
  ...
  8_MarkDuplicates:
    ...
    run:
      class: Operation
      id: agentshed_g2_bx_psu_edu_repos_devteam_picard_picard_MarkDuplicates_2_18_2_2
      inputs:
        inputFile:
          format: Any
          type: File
  ...
  9_MultiQC:
    in:
      results_0|software_cond|output_0|type|input: 7_Samagents stats/output
    out:
    - stats
    - plots
    - html_report
